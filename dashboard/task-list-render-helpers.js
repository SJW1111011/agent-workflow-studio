(function (root, factory) {
  ...
  const formatVerificationGateLabel =
    typeof executionHelpers.formatVerificationGateLabel === "function"
      ? executionHelpers.formatVerificationGateLabel
      : (status) => String(status || "unknown");
  const isVerificationGateWarning =
    typeof executionHelpers.isVerificationGateWarning === "function" ? executionHelpers.isVerificationGateWarning : () => false;
    ...
    return `
      <article class="task-card ${cardToneClass} ${task.id === activeTaskId ? "active" : ""}" data-task-id="${escapeHtml(task.id)}">
        ...
        <div class="tag-row">
          ...
          <span class="tag ${isVerificationGateWarning(task.verificationGateStatus) ? "warn" : ""}">${escapeHtml(
