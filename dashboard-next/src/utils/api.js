export function createDashboardApiClient(fetchImpl) {
...
export function createJsonRequestOptions(method, body) {
  return {
    method,
    headers: {
...
export function buildTaskExecutionLogUrl(taskId, stream, maxChars = 6000) {
...
export function buildRunLogUrl(taskId, runId, stream) {
