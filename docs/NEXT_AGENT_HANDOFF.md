...
- a clean temp install of `agent-workflow-studio@0.1.2` has now re-verified the npm-first bootstrap path end to end: `init`, `scan`, `memory:bootstrap`, `quick`, `validate`, and dashboard launch all work from the published package
