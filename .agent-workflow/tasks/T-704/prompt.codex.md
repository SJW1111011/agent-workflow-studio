...
- .agent-workflow/tasks/T-704/task.md
- .agent-workflow/tasks/T-704/context.md
- .agent-workflow/tasks/T-704/verification.md
...
- Record runs in .agent-workflow/tasks/T-704/runs.
