...
- .agent-workflow/tasks/T-204/task.md
- .agent-workflow/tasks/T-204/context.md
- .agent-workflow/tasks/T-204/verification.md
...
- Record runs in .agent-workflow/tasks/T-204/runs.
