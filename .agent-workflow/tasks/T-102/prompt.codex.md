...
- .agent-workflow/tasks/T-102/task.md
- .agent-workflow/tasks/T-102/context.md
- .agent-workflow/tasks/T-102/verification.md
...
- Record runs in .agent-workflow/tasks/T-102/runs.
