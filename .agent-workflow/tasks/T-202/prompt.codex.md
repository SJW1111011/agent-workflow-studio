...
- .agent-workflow/tasks/T-202/task.md
- .agent-workflow/tasks/T-202/context.md
- .agent-workflow/tasks/T-202/verification.md
...
- Record runs in .agent-workflow/tasks/T-202/runs.
