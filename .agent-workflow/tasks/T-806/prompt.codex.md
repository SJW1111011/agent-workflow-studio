...
- .agent-workflow/tasks/T-806/task.md
- .agent-workflow/tasks/T-806/context.md
- .agent-workflow/tasks/T-806/verification.md
...
# T-806 - 真实 Agent 测试：用 Codex 验证工作流
...
- Record runs in .agent-workflow/tasks/T-806/runs.
