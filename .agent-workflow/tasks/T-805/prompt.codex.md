...
- .agent-workflow/tasks/T-805/task.md
- .agent-workflow/tasks/T-805/context.md
- .agent-workflow/tasks/T-805/verification.md
...
- Record runs in .agent-workflow/tasks/T-805/runs.
