...
- .agent-workflow/tasks/T-803/task.md
- .agent-workflow/tasks/T-803/context.md
- .agent-workflow/tasks/T-803/verification.md
...
- Record runs in .agent-workflow/tasks/T-803/runs.
