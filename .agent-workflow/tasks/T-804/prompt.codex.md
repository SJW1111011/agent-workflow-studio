...
- .agent-workflow/tasks/T-804/task.md
- .agent-workflow/tasks/T-804/context.md
- .agent-workflow/tasks/T-804/verification.md
...
- Record runs in .agent-workflow/tasks/T-804/runs.
