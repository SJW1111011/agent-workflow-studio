...
- .agent-workflow/tasks/T-200/task.md
- .agent-workflow/tasks/T-200/context.md
- .agent-workflow/tasks/T-200/verification.md
...
- Record runs in .agent-workflow/tasks/T-200/runs.
