...
- .agent-workflow/tasks/T-801/task.md
- .agent-workflow/tasks/T-801/context.md
- .agent-workflow/tasks/T-801/verification.md
...
- Record runs in .agent-workflow/tasks/T-801/runs.
