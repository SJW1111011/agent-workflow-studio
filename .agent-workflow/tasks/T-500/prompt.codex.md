...
- .agent-workflow/tasks/T-500/task.md
- .agent-workflow/tasks/T-500/context.md
- .agent-workflow/tasks/T-500/verification.md
...
- Record runs in .agent-workflow/tasks/T-500/runs.
