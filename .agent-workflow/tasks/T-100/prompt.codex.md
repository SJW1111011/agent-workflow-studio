...
- .agent-workflow/tasks/T-100/task.md
- .agent-workflow/tasks/T-100/context.md
- .agent-workflow/tasks/T-100/verification.md
...
- Record runs in .agent-workflow/tasks/T-100/runs.
