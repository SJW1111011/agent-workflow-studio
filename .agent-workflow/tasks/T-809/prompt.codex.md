...
- .agent-workflow/tasks/T-809/task.md
- .agent-workflow/tasks/T-809/context.md
- .agent-workflow/tasks/T-809/verification.md
...
- Record runs in .agent-workflow/tasks/T-809/runs.
