...
- .agent-workflow/tasks/T-807/task.md
- .agent-workflow/tasks/T-807/context.md
- .agent-workflow/tasks/T-807/verification.md
...
- Record runs in .agent-workflow/tasks/T-807/runs.
